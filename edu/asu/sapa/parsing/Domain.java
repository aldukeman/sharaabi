...
public class Domain {
    ...
    ArrayList derivedpredicates = new ArrayList(); //added by bharat
    ...
    public void putDP(DerivedPredicate d){
        derivedpredicates.add(d);
    }
    ...
    public DerivedPredicate getDPred(int index) {
	return (DerivedPredicate) derivedpredicates.get(index);
    }

...
public class PDDL21Parser implements PDDL21ParserConstants {
	 ...
	 */
        ...
        System.out.println("\u005cn********* Problem Specification *****");
  ...
  static final public Domain parse_domain_pddl() throws ParseException {
    ...
    if (jj_2_4(3)) {
      ...
      while (true) {
        ...
        aDomain.putType(t.image.toLowerCase());
          if (jj_2_2(3)) {
            ;
          } else {
            break label_2;
    ...
    label_5:
    while (true) {
      aArrayList = structureDefs();
        for( i = 0; i < aArrayList.size(); i++ ) {
            Object o = aArrayList.get(i);
            if(o instanceof DerivedPredicate){
                DerivedPredicate dp = (DerivedPredicate)o;
                aDomain.putDP(dp);
            }
            else
                aDomain.putAction((Action) o);
        }
      if (jj_2_10(3)) {
        ;
      } else {
...
/*bhaidb*/
  static final public ArrayList structureDefs() throws ParseException {
    ArrayList v = new ArrayList();
    Action a;
    DerivedPredicate dp;
    ArrayList temp;
...
/*bha****/
  static final public ArrayList StrDef() throws ParseException {
    ArrayList str = new ArrayList();
    Token t;
    Action act = new Action();
    DerivedPredicate dp = new DerivedPredicate();
    jj_consume_token(OPENBRACE);
    if (jj_2_42(3)) {
      ...
      jj_consume_token(DERIVEDPREDICATE);
        dp = DerivedPred();
        str.add(dp);
    } else {
      jj_consume_token(-1);
...
/***bhaidb**/
  static final public DerivedPredicate DerivedPred() throws ParseException {
    Token t;
    DerivedPredicate dp = new DerivedPredicate();
    PredicateFormula pf = new PredicateFormula();
    ...
    while (true) {
      ...
      if (jj_2_47(3)) {
        ...
        isTyped = true;
        t = jj_consume_token(NAME);
        dp.putPara(paraSet, t.image.toLowerCase());
        paraSet.clear();
      } else {
        ;
      }
  ...
  static final public PredicateFormula predform() throws ParseException {
    Token t;
    PredicateFormula pf = new PredicateFormula();
    Function f;
    PredicateFormula pf1, pf2;
    Predicate p;
    PredicateFormula tempPf;
    ArrayList paraSet = new ArrayList();
    boolean isTyped = false;
    if (jj_2_63(3)) {
      p = ActionPred();
        System.out.println("predform- actionpred");
        pf.setPredicate(p);
        {if (true) return pf;}
    } else if (jj_2_64(3)) {
      if (jj_2_59(3)) {
        ...
        tempPf = predform();
        System.out.println("predform- notform");
        pf.isNOTTrue();
        pf.setPredForm(tempPf);
        {if (true) return pf;}
      } else if (jj_2_60(3)) {
        jj_consume_token(OPENBRACE);
        if (jj_2_48(3)) {
        ...
        jj_consume_token(OPENBRACE);
        System.out.println("predform- or/andform");
        pf.ORAND(t.image.toLowerCase());
        label_21:
        while (true) {
          tempPf = predform();
           System.out.println("predform- or/andform- going in..");
           pf.setPredForm(tempPf);
          if (jj_2_50(3)) {
            ;
          } else {
        ...
        jj_consume_token(OPENBRACE);
    System.out.println("predform- either or implies");
    pf.eitherimplies(t.image.toLowerCase());
        label_22:
        while (true) {
          tempPf = predform();
           pf.setPredForm(tempPf);
    ...
    System.out.println("predform- forall or exists");
    pf.faexist(t.image.toLowerCase());
        label_23:
        while (true) {
          if (jj_2_56(3)) {
            ;
        ...
        isTyped = true;
            t = jj_consume_token(NAME);
        pf.putParaFE(paraSet, t.image.toLowerCase());
        paraSet.clear();
          } else {
            ;
          }
        ...
        jj_consume_token(CLOSEBRACE);
        if( !isTyped )
            pf.putParaFE(paraSet, "basic_type");
        tempPf = predform();
            pf.setPredForm(tempPf);
      } else {
        jj_consume_token(-1);
...
/******/
  ...
  static private boolean jj_3_44() {
    if (jj_scan_token(DERIVEDPREDICATE)) return true;
    return false;
  }
